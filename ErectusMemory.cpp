...
{
	BYTE InfiniteAmmoOn[] = { 0xEB, 0x0A, 0x90, 0x48, 0x81, 0xC4, 0x90, 0x00, 0x00, 0x00, 0x5D, 0xC3, 0xB8, 0xE7, 0x03, 0x00, 0x00, 0x89, 0x45, 0x77, 0xEB, 0xED };
	BYTE InfiniteAmmoOff[] = { 0x8B, 0x45, 0x77, 0x48, 0x81, 0xC4, 0x90, 0x00, 0x00, 0x00, 0x5D, 0xC3, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC };
...
bool OnePositionKill(DWORD64 *OpkPage, bool *OpkPageValid, bool State)
{
	...
	BYTE OpkOn[]
	{
		0x48, 0x8D, 0x05, 0x06, 0x00, 0x00, 0x00,		//lea rax, [OpkPageAddress]
		0x48, 0x8B, 0x00,								//mov rax, [rax]
		0xFF, 0xE0,										//jmp rax
		0xCC,											//Padding
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	//OpkPage
	...
	memcpy(&OpkOn[0xD], &*OpkPage, sizeof(DWORD64));

	DWORD64 PageCheck;
	memcpy(&PageCheck, &OpkCheck[0xD], sizeof(DWORD64));
...
void RenderData()
{
	...
	sprintf_s(PositionSpoofingText, "Spoofed Position (Height): %d (%d)", int(CustomLocalPlayerSettings.PositionSpoofingEnabled), CustomLocalPlayerSettings.PositionSpoofingHeight);
...
{
	BYTE PositionSpoofingOn[] = { 0xBA, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x1F, 0x80, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x1F, 0x80, 0x00, 0x00, 0x00, 0x00 };
	BYTE PositionSpoofingOff[] = { 0x3B, 0xC2, 0x7C, 0x0F, 0x41, 0xB8, 0xFF, 0xFF, 0x07, 0x00, 0x8B, 0xD0, 0x41, 0x3B, 0xC0, 0x41, 0x0F, 0x4F, 0xD0 };
